...
const CartPage = () => {
  ...
  return (
    <div className="bg-white">
      <SectionTitle title="Корзина" path="Главная | Корзина" />
      <div className="bg-white">
            ...
            >
              ...
              <dl className="mt-6 space-y-4">
                <div className="flex items-center justify-between">
                  <dt className="text-sm text-gray-600">примерная стоимость</dt>
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                  <dt className="flex items-center text-sm text-gray-600">
                    ...
                    >
                      <span className="sr-only">
                        Узнайте больше о том, как рассчитывается доставка
                      </span>
                      <FaCircleQuestion
                        className="h-5 w-5"
                        aria-hidden="true"
                  ...
                  <dd className="text-sm font-medium text-gray-900">1000 руб.</dd>
                </div>
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                  <dt className="flex text-sm text-gray-600">
                    <span>Расчет налогов</span>
                    <a
                      href="#"
                      className="ml-2 flex-shrink-0 text-gray-400 hover:text-gray-500"
                    >
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                  ...
                  <dd className="text-base font-medium text-gray-900">
                    руб.{total === 0 ? 0 : Math.round(total + total / 5 + 5)}
                  </dd>
                </div>
              </dl>
              {products.length > 0 && (
