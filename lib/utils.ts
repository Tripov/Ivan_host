...
export const navigation = {
  sale: [
    { name: "Скидки", href: "#" },
    { name: "Новости", href: "#" },
    { name: "Зарегистрировать скидки", href: "#" },
  ],
  about: [
    { name: "Больше о Jewelry Мязина", href: "#" },
    { name: "Работайте с нами", href: "#" },
    { name: "Профиль компании", href: "#" },
  ],
  buy: [
    { name: "Jewelry Мязина card", href: "#" },
  ...
  help: [
    { name: "Контакт", href: "#" },
    { name: "Как купить в Jewelry Мязина", href: "#" },
    { name: "FAQ", href: "#" },
  ],
};
